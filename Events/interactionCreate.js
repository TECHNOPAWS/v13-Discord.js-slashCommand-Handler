...
//Destructure commands from ../Handlers/slashCommands.js
const { commands } = require(`${process.cwd()}/Handlers/slashCommands.js`)
...
module.exports = {
  ...
  async execute({ client, parameter: [interaction] }) {
    ...
    let getCommand = client.slashCommands.find(cmd => cmd.data.name == interaction.commandName)
